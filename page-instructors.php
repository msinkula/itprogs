...
<section id="content" role="main">
    ...
    <section id="sub-pages">
		...
		<?php
           if ( get_post_meta($pageChild->ID, 'spacer-title', true) )
            {
                echo '<h2 class="spacer">' . get_post_meta($pageChild->ID, 'spacer-title', true) . '</h2>';
            }else{
        ?>
        
        <article class="subs with-image" id="<?=$pageChild->ID?>">
